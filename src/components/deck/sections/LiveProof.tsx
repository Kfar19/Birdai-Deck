...
import { ExecutionTruthToggle } from "@/components/deck/ExecutionTruthToggle";

// ============================================
// LIVE PROOF SECTION
// 
// Two-part interactive experience:
// 1. Timeline scrubber showing execution window
// 2. Price-only vs Execution Truth toggle
// ============================================
...
export function LiveProof() {
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      {/* Part 2: Price-only vs Execution Truth Toggle */}
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        whileInView={{ opacity: 1, y: 0 }}
      ...
      <motion.div
        ...
        className="text-center font-mono text-[11px] uppercase tracking-[0.2em] text-zinc-500"
      >
